    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                # --- Conditional pass ---
                with self.transformer.cache_context("cond", step=i, sigma=sigma, num_steps=self._num_timesteps):
                ...
                if self.do_classifier_free_guidance:
                    with self.transformer.cache_context("uncond", step=i, sigma=sigma, num_steps=self._num_timesteps):
                        preds_vision, preds_sound, preds_action = self.transformer(
